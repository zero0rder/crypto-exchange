...
cacheClient.on('error', (e) => console.error(e));
...
async function getOrSetCache(req, res, next){
    ...
    cachedRes = await cacheClient.get(originalUrl);
    ...
    if(cachedRes) {
        ...
        req.isCached = false;
        req.setCacheItem = async (data) => await cacheClient.set(originalUrl, JSON.stringify(data), {
